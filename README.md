...
This is a sample template for aws-sdk-mock-sample - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-sdk-mock-sample \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sdk-mock-sample --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sdk-mock-sample
```
